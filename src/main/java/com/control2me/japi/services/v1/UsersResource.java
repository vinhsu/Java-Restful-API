...
//	#http://localhost:8080/japi/services/v1/users/xx
//	@GET
//	@Path("xx")
...
//	}
	...
	public Response getUserById(@ApiParam(value = "userId", required = true, defaultValue = "23456", allowableValues = "", allowMultiple = false)
		...
		User user = null;
		try {
			user = BusinessManager.getInstance().findUser(userId);
		} catch (Exception e) {
	...
	@ApiOperation(value = "Create a new User", 
	    ...
	    @ApiResponse(code = 400, message = "Failed: {\"error\":\"error description\", \"status\":\"FAIL\"}") })
	public Response createUser(@ApiParam(value = "New User", required = true, defaultValue = "\"{\"name\":\"Tom Jay\"}\"", 
